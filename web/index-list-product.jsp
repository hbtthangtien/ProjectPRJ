<%-- 
    Document   : index-list-product
    Created on : Apr 9, 2024, 6:03:39 PM
    Author     : hbtth
--%>
                ...
                <div class="container">
                    <div class="page-exit">
                        <ul>
                            ...
                            <li><span>></span></li>
                            <c:if test="${idType == null || idType.length() == 0}">
                                <c:set var="idType" value="0"/>
                            </c:if>
                            <c:set var="i" value="${category.getTypeByID(idType)}"/>
                            <c:set var="name" value="${category.nameCategory}  ${i!=null?'>':''}   ${i!=null?(i.nameType):''}"/>
                            <li>${name}</li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="slider-content">
                        ...
                        <div class="slider-content-top-container">
                            <div class="slider-content-top">
                                <c:forEach items="${category.listImageBanner}" var="i">
                                    <a href="#"><img src="${i.nameImageBanner}" alt=""></a>
                                    </c:forEach>
                            </div>
                ...
                <div class="container">
                    <div class="box-home">
                                    ...
                                    <div class="sub-menu-ip">
                                        <div class="item-box-active">
                                            <div class="sub-item_ip">
                                                <c:set var="decor" value="style='color: blue;font-weight: 600;border-bottom: 2px solid blue;'"/>
                                                <a href="listproduct?idCategory=${category.idCategory}" 
                                                   ${idType=="0"?decor:''}>Tất cả</a>
                                            </div>
                                        </div>
                                        <c:forEach items="${category.listtype}" var="i">
                                            <div class="item-box">
                                                <div class="item-box-ip">
                                                    <a href="listproduct?idCategory=${category.idCategory}&idType=${i.idType}"
                                                       ${i.idType == idType ? decor :''}
                                                       > 
                                                        ${i.nameType}
                                                    </a>
                                                </div>
                        ...
                        <div class="product-selectors-1">
                            <div class="product-viewmode">
                                <select>
                                    <option value="0">Thứ tự hiển thị</option>
                                ...
                                <div class="item">
                                    ...
                                    <div class="info">
                                        <div class="info-main">
                                            ...
                                            <span>
                                                <strong>${FormatMoney.format(i.salePrice)}đ
                                                </strong>
                                                <s>
                                                    ${FormatMoney.format(i.primePrice)}đ</s>
                                            </span>
                                        </div>
