<%-- 
    ...
    Created on : Apr 9, 2024, 10:14:30 AM
    Author     : hbtth
--%>
            ...
            <section>
                <div class="page-user">
                    <div class="page-user-body">
                        <div class="img-page">
                            <img src="img/TND_M402_010 1.jpeg" alt="">
                        </div>
                        <form class="form-user" action="register" method="POST" autocomplete="off">
                                ...
                                <div class="info-user">
                                    ...
                                    <div class="info-form">
                                        <div class="input-name">
                                            <p>Họ và tên:</p>
                                            <input type="text" name="fullname" placeholder="Please enter your fullname..." required>
                                        </div>
                                        <div class="input-gender">
                                            <p>Giới tính:</p>
                                            <div class="gender" style="display: flex">
                                                <input id="1" type="radio" name="gender" value="1" checked>
                                                <label for="1">Nam</label>
                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                <input id="0" type="radio" name="gender" value="0" >
                                                <label for="0">Nữ</label>
                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                <input id="2" type="radio" name="gender" value="2" >
                                                <label for="2">Other</label>
                                            </div>
                                        </div>
                                        <div class="input-date-of-birth">
                                            <p>Ngày sinh:</p>
                                            <div class="date-off-birth">
                                                ...
                                                <!-- </div> -->
                                                <!-- <div class="DateOfBirthMonth"> -->
                                                <select name="month" required="">
                                                    <option value="0">Tháng
                                                    <option value="1">1
                                                    <option value="2">2
                                                    <option value="3">3
                                                    <option value="4">4 
                                        ...
                                        <div class="input-numberphone">
                                            <p>Điện thoại:</p>
                                            <input type="text" name="phoneNumber" placeholder="Please enter your phone number..." required>
                                        </div>
